    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            else if (packageWeight < 50)
            {
                ...
                bool packageTooBig = ((packageHeight + packageLength + packageWidth) >= 50);

                if (packageTooBig == true)
                {
                    Console.WriteLine("Your package is too large to be shipped via Package Express. Have a good day.");
                    Console.ReadLine();
                }
